...
function seedData() {
  ...
  const setup1 = {
    ...
    name: 'RX8E Basic Setup',
    date: new Date().toISOString(),
    trackId: '',
    notes: 'Grundsetup för RX8E 2026 enligt setup sheet',
    ...
    chRhF: 5.0, chRhR: 5.0, chCbF: -2.0, chCbR: -2.0,
    chToF: 0.0, chToR: 2.0, chShF: '450', chShR: '400',
    chSpF: 'Medium', chSpR: 'Medium-Soft',
    chDfF: '7000', chDfR: '3000', chDfC: '10000',
    chArF: true, chArR: false, chNotes: 'Basic RX8E setup: Ride height 5.0mm front/rear. Camber -2.0° front/rear. Toe 0° front, 2° rear. Shock oil 450/400. Diff oil 7000/3000/10000. Anti-roll bar front only.',
